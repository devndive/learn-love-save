...
echo "{ \"filename\": \"/css/learn-love-save-$HASH.css\", \"sri\": \"sha${SRI_FUNCTION}-$SRI\" }" > ./data/assets/css/lls.json
echo "{ \"filename\": \"/js/learn-love-save-$HASH_JS.js\", \"sri\": \"sha${SRI_FUNCTION}-$SRI_JS\" }" > ./data/assets/js/lls.json
